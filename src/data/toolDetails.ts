...
export const toolDetailsData: Record<string, ToolDetails> = {
  ...
  notebooklm: {
    ...
    howToUse: [
      ...
      { title: "Ask Specific Questions", description: "Ask targeted questions about your content. NotebookLM provides answers with direct citations from your sources. Every answer includes source citations you can click to verify." },
      { title: "Generate Study Guides", description: "Use NotebookLM to automatically create study guides, summaries, FAQs, timelines, and outlines from your sources." }
    ],
    benefits: [
      { title: "Grounded in Your Sources", description: "Unlike ChatGPT, NotebookLM only uses information from your uploaded documents, ensuring accurate answers." },
      { title: "Automatic Citations", description: "Every answer includes clickable citations to the exact source location." },
      { title: "Free & Privacy-Focused", description: "Completely free to use. Your documents are private and not used to train AI models." },
      { title: "Multi-Format Support", description: "Works with PDFs, Google Docs, websites, YouTube videos, and audio files." }
    ],
    monetization: {
      services: [
      ...
      toolCombinations: [
        "NotebookLM + ChatGPT (research + content)",
        "NotebookLM + Grammarly (research + writing)",
        "NotebookLM + Notion (research + organization)"
      ],
      tips: [
        "Offer research digest service: $50-150 per project",
        "Create study guides: $30-75 per guide",
        "Literature review services: $100-300",
        "Target students, researchers, consultants"
      ]
    },
    roadmap: [
      {
        ...
        title: "Master the Tool",
        steps: [
          "Create test notebooks with different content types",
          "Practice asking various questions",
          "Build portfolio samples",
          "Learn citation system"
        ],
        earnings: "$0 - Learning phase"
      },
      {
        phase: "Week 3-4",
        title: "First Clients",
        steps: [
          "Create service offerings on Fiverr",
      ...
      },
      {
        ...
        steps: [
          "Offer comprehensive research packages",
          "Target businesses and consultants",
